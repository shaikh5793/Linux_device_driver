...
/*
 * VSOC-3000 CSI-2 Receiver Subdev -- Part 11: Multi-Subdev Pipeline
 *
 * Copyright (c) 2024 TECH VEDA
 * Author: Raghu Bharadwaj
 *
 * Same as Part 10 CSI-2 — platform subdev with 2 pads, format passthrough,
 * and link_validate.  In Part 11 the CSI-2 sits between the sensor and
 * the ISP in the 4-entity pipeline:
 *
...
/*
 * vsoc_csi2_s_stream — Part 11
 *
 * Identical to Part 10. CSI-2 is stable from Part 10 onward.
 * Pipeline growth happens in bridge (ISP discovery) and ISP module.
 */
...
MODULE_DESCRIPTION("VSOC-3000 CSI-2 Receiver -- Part 11: Multi-Subdev Pipeline");
