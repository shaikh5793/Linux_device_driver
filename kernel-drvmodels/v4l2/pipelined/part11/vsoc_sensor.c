...
/*
 * VSOC-3000 Virtual Camera Sensor -- Part 11: Multi-Subdev Pipeline
 *
 * Copyright (c) 2024 TECH VEDA
 * Author: Raghu Bharadwaj
 *
 * Same as Part 10 sensor — I2C subdev with pad ops, controls, media entity,
 * and async registration.  The sensor produces Bayer SRGGB10 data that
 * flows through the full 4-entity pipeline:
 *
...
/*
 * vsoc_sensor_probe -- Part 11: Multi-Subdev Pipeline
 *
...
/*
 * vsoc_sensor_remove -- Part 11: Multi-Subdev Pipeline
 *
 * Identical to Part 8 -- sensor is stable from Part 8 onward.
 * Pipeline growth happens in bridge, CSI-2, and ISP modules.
 *
...
MODULE_DESCRIPTION("VSOC-3000 Virtual Sensor -- Part 11: Multi-Subdev Pipeline");
