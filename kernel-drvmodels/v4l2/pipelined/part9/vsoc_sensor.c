...
/*
 * VSOC-3000 Virtual Camera Sensor -- Part 9: Media Links & Topology
 *
 * Copyright (c) 2024 TECH VEDA
 * Author: Raghu Bharadwaj
 *
 * Same as Part 8 sensor (no changes needed for Part 9).
 * The sensor has 1 source pad and registers as MEDIA_ENT_F_CAM_SENSOR.
 *
 * Load order:
 *   1. insmod soc_hw_platform.ko
 *   2. insmod vsoc_csi2.ko     (CSI-2 receiver, SoC-internal)
...
/*
 * vsoc_sensor_probe -- Part 9: Media Links & Topology
 *
...
/*
 * vsoc_sensor_remove -- Part 9: Media Links & Topology
 *
 * Identical to Part 8 -- sensor is stable from Part 8 onward.
 * Pipeline growth happens in bridge, CSI-2, and ISP modules.
 *
...
MODULE_DESCRIPTION("VSOC-3000 Virtual Sensor -- Part 9: Media Links & Topology");
